var BanTimeline = {
  ...
  reset: function () {
      ...
      TweenLite.to(frame2txt, 0, {opacity:0, left:160});
      TweenLite.to(frame3txt, 0, {opacity:0, left:160});
      TweenLite.to(frame4txt, 0, {opacity:0, left:160});
  ...
  replayFunction: function () {
        ...
        replay_container.onmouseover = function () {
          TweenLite.to(replay_container, 1, {rotation: -360});
        }
        replay_container.onmouseout = function () {
          TweenLite.to(replay_container, 0, {rotation: 0});
        }
