var BanTimeline = {
  ...
  reset: function () {
        TweenLite.to(frame1, 0, {display: "block"});
        TweenLite.to(frame3, 0, {display: 'block'});
  ...
  rain: function () {
      TweenLite.to(rain1, 0, {display:"block",opacity:1, top:-520,left:100});  
      TweenLite.to(rain2, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain3, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain4, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain5, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain6, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain7, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain8, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain9, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain10, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain11, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain12, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain13, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain14, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain15, 0, {display:"block",opacity:1, top:-520,left:100});
      TweenLite.to(rain16, 0, {display:"block",opacity:1, top:-520,left:100});
    
    if(BanTimeline.rainOn == 1)
    {
      TweenLite.to(rain1, .7, {top:80,left:-30, delay:0});
      TweenLite.to(rain1, .3, {opacity:0, delay:.2});   

      TweenLite.to(rain2, 1.3, {top:100,left:-30, delay:.2});
       TweenLite.to(rain2, 1, {opacity:0, delay:.4});

      TweenLite.to(rain3, 1.3, {top:100,left:-30, delay:.4});
      TweenLite.to(rain3, 1, {opacity:0, delay:.6});

      TweenLite.to(rain4, 1.3, {top:100,left:-30, delay:.6});
      TweenLite.to(rain4, 1, {opacity:0, delay:.8});

      TweenLite.to(rain5, 1.3, {top:100,left:-30, delay:.8});
      TweenLite.to(rain5, 1, {opacity:0, delay:1});

      TweenLite.to(rain6, 1.3, {top:100,left:-30, delay:1});
      TweenLite.to(rain6, 1, {opacity:0, delay:1.2});

      TweenLite.to(rain7, 1.3, {top:100,left:-30, delay:1.2});
      TweenLite.to(rain7, 1, {opacity:0, delay:1.4});

      TweenLite.to(rain8, 1.3, {top:100,left:-30, delay:1.4});
      TweenLite.to(rain8, 1, {opacity:0, delay:1.6});

      TweenLite.to(rain9, 1.3, {top:100,left:-30, delay:1.6});
      TweenLite.to(rain9, 1, {opacity:0, delay:1.8});

      TweenLite.to(rain10, 1.3, {top:100,left:-30, delay:1.8});
      TweenLite.to(rain10, 1, {opacity:0, delay:2});

      TweenLite.to(rain11, 1.3, {top:100,left:-30, delay:2});
      TweenLite.to(rain11, 1, {opacity:0, delay:2.2});

      TweenLite.to(rain12, 1.3, {top:100,left:-30, delay:2.2});
      TweenLite.to(rain12, 1, {opacity:0, delay:2.4});

      TweenLite.to(rain13, 1.3, {top:100,left:-30, delay:2.4});
      TweenLite.to(rain13, 1, {opacity:0, delay:2.6});

      TweenLite.to(rain14, 1.3, {top:100,left:-30, delay:2.6});
      TweenLite.to(rain14, 1, {opacity:0, delay:2.8});

      TweenLite.to(rain15, 1.3, {top:100,left:-30, delay:2.8});
      TweenLite.to(rain15, 1, {opacity:0, delay:3});

      TweenLite.to(rain16, 1.3, {top:100,left:-30, delay:3});
      TweenLite.to(rain16, 1, {opacity:0, delay:3.5});
      
      TweenLite.delayedCall(3.3, BanTimeline.rain);
    } 
  },
  ...
  frame3: function () {
    ...
    TweenLite.to(brightsky, .4, {display:"block",opacity:.8, delay:3});
  ...
  frame4: function () {
    ...
    TweenLite.to(frame1, 0, {display:"none", delay: .24});
    TweenLite.to(frame3, 0, {display:"none", delay: .24});
