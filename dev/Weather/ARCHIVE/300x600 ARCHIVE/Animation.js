var BanTimeline = {
  ...
  glow: function() {
    if(BanTimeline.glowBtn == 1){
      ...
      container.onmouseover = function(){      
        ...
        TweenLite.to(switch_glow5, 0.4, {scaleX:1.1, scaleY:1.1, delay:0});
        ...
        if(BanTimeline.glowBtn2 == 1){
          ...
          TweenLite.to(cta_shine5, .4, {scaleX:1.05, scaleY:1.1, delay:0});
  ...
  rain: function () {
      ...
      TweenLite.to(rain10, 0, {display:"block",opacity:1, top:-520,left:100, delay:1});
      TweenLite.to(rain11, 0, {display:"block",opacity:1, top:-520,left:100, delay:1});
      TweenLite.to(rain12, 0, {display:"block",opacity:1, top:-520,left:100, delay:1});
      TweenLite.to(rain13, 0, {display:"block",opacity:1, top:-520,left:100, delay:1});
      TweenLite.to(rain14, 0, {display:"block",opacity:1, top:-520,left:100, delay:1});
    if(BanTimeline.rainOn == 1)
    {
      TweenLite.to(rain1, 1.3, {top:250,left:-70, delay:0});  
      TweenLite.to(rain2, 1.3, {top:250,left:-70, delay:.2});
      TweenLite.to(rain3, 1.3, {top:250,left:-70, delay:.4});
      TweenLite.to(rain4, 1.3, {top:250,left:-70, delay:.6});
      TweenLite.to(rain5, 1.3, {top:250,left:-70, delay:.8});
      TweenLite.to(rain6, 1.3, {top:250,left:-70, delay:1});
      TweenLite.to(rain7, 1.3, {top:250,left:-70, delay:1.2});
      TweenLite.to(rain8, 1.3, {top:250,left:-70, delay:1.4});
      TweenLite.to(rain9, 1.3, {top:250,left:-70, delay:1.6});
      TweenLite.to(rain10, 1.3, {top:250,left:-70, delay:1.8});
      TweenLite.to(rain11, 1.3, {top:250,left:-70, delay:2});
      TweenLite.to(rain12, 1.3, {top:250,left:-70, delay:2.2});
      TweenLite.to(rain13, 1.3, {top:250,left:-70, delay:2.4});
      TweenLite.to(rain14, 1.3, {top:250,left:-70, delay:2.6});

      TweenLite.to(rain1, 1, {opacity:0, delay:.2});  
      ...
      TweenLite.to(rain14, 1, {opacity:0, delay:2.6});
    }
  ...
  frame4: function () {
    ...
    TweenLite.to(end_lightning_1, .02, {display:"none", delay: .12});
    ...
    TweenLite.to(end_lightning_5, .02, {display:"block", delay: .12});
