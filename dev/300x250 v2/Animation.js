var BanTimeline = {
  ...
  reset: function () {
    ...
    // TweenLite.to(frame3, 0, {display: 'none'});
        ...
        // TweenLite.to(switch_glow1, 0, {display: 'none', opacity:0});
        // TweenLite.to(switch_glow2, 0, {display: 'none', opacity:0});
        // TweenLite.to(switch_glow3, 0, {display: 'none', opacity:0});
        // TweenLite.to(switch_glow4, 0, {display: 'none', opacity:0});
        // TweenLite.to(switch_glow5, 0, {display: 'none', opacity:0});

        // TweenLite.to(cta_shine1, 0, {display: 'none',opacity:0});
        // TweenLite.to(cta_shine2, 0, {display: 'none',opacity:0});
        // TweenLite.to(cta_shine3, 0, {display: 'none',opacity:0});
        // TweenLite.to(cta_shine4, 0, {display: 'none',opacity:0});
        ...
        // TweenLite.to(left_light1, 0, {display:"none"});
        // TweenLite.to(left_light2, 0, {display:"none"});
        // TweenLite.to(left_light3, 0, {display:"none"});

        // TweenLite.to(whiteBg, 0, {display:"none"});
        // TweenLite.to(right_light1, 0, {display:"none", opacity:0});
        // TweenLite.to(right_light2, 0, {display:"none", opacity:0});
        // TweenLite.to(right_light3, 0, {display:"none", opacity:0});
        // TweenLite.to(dontLet, 0, {opacity:0,left:300});
        // TweenLite.to(noSignal1, 0, {display:"none"});
